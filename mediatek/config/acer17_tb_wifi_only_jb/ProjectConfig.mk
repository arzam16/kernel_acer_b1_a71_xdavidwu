...
CUSTOM_HAL_SUB_LENS=
CUSTOM_KERNEL_ACCELEROMETER=mc3210
CUSTOM_KERNEL_ALSPS=
CUSTOM_KERNEL_BATTERY=battery
...
MTK_PRODUCT_LOCALES=en_US en_AU en_GB en_CA fr fr_CA fr_FR it it_IT iw_IL pt_PT es es_ES de de_DE cs_CZ pl pl_PL da da_DK fi fi_FI km_KH ko ko_KR fr_CA hu hu_HU ro ro_RO ru ru_RU my_MM nl nl_NL nb_NO sv_SE el_GR ar ar_EG th th_TH tr tr_TR uk_UA vi_VN in_ID pt_BR ja_JP zh_CN zh_TW mdpi hdpi
MTK_QVGA_LANDSCAPE_SUPPORT=no
MTK_RAT_BALANCING=no
MTK_RAT_WCDMA_PREFERRED=no
MTK_RCSE_SUPPORT=no
MTK_RELEASE_PACKAGE=rel_customer_basic rel_customer_tablet
...
RESOURCE_OVERLAY_SUPPORT=generic generic_WIFIONLY
